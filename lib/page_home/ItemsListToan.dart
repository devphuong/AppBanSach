...
class ItemsListCDOTO extends StatefulWidget {
  final ItemTapCallback onItemTap;

  ItemsListCDOTO({required this.onItemTap});

  @override
  _ItemsListState createState() => _ItemsListState();
}

class _ItemsListState extends State<ItemsListCDOTO> {
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          try {
            ...
            if (product.category == "CĐ Chuyên Ngành Ô Tô") {
