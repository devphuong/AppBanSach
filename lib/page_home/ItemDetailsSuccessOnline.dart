...
class ItemProductSuccess {
  ...
  factory ItemProductSuccess.fromJson(Map<String, dynamic> json) {
...
class ItemDetailsSuccessOnlinePage extends StatefulWidget {
  final String assetPath;
  final String cookieprice;
  final String cookiename;
  final ItemProductSuccess productSuccess;

  ItemDetailsSuccessOnlinePage({
    required this.assetPath,
    required this.cookieprice,
    required this.cookiename,
    required this.productSuccess,
  });
...
class _ItemDetailsSuccessState extends State<ItemDetailsSuccessOnlinePage> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Center(
                      child: Hero(
                        ...
                        child: ClipRRect(
                          ...
                          child: widget.productSuccess.imgProduct.isNotEmpty
                              ? CachedNetworkImage(
                                  imageUrl: widget.productSuccess.imgProduct,
                                  fit: BoxFit.cover,
                    ...
                    if (widget.productSuccess.album != null &&
                        widget.productSuccess.album!.isNotEmpty)
                      _buildAlbumSection(widget.productSuccess.album!),
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(width: 10.0),
                        if (widget.productSuccess.promotionalPrice != null) ...[
                          RichText(
                            text: TextSpan(
                              children: [
                                TextSpan(
                                ...
                                TextSpan(
                                  text:
                                      ' ₫${NumberFormat.currency(locale: 'vi', symbol: '').format(widget.productSuccess.promotionalPrice)}',
                                  style: TextStyle(
                                    fontSize: 18.0,
                                    color:
                    ...
                    SizedBox(height: 20.0),
                    // Text(
                    //   'Số lượng: ${widget.productSuccess.quantity}',
                    //   style: TextStyle(
                    //     fontSize: 18.0,
                    //     color: Colors.black,
                    //   ),
                    // ),
                    // if (widget.productSuccess.quantity == 0)
                    //   Text(
                    //     'Hết hàng',
                    //     style: TextStyle(
                    //       fontSize: 18.0,
                    ...
                    //       icon: Icon(Icons.add),
                    //       onPressed:
                    //           selectedQuantity < widget.productSuccess.quantity
                    //               ? () {
                    //                   setState(() {
                    //                     selectedQuantity++;
                    //                     _saveSelectedQuantity(selectedQuantity);
                    ...
                    // ),
                    SizedBox(height: 20.0),
                    if (widget.productSuccess.detailedDescription.isNotEmpty)
                      _buildDescriptionSection('Mô tả chi tiết:',
                          widget.productSuccess.detailedDescription),
                    if (widget.productSuccess.shortDescription.isNotEmpty)
                      _buildDescriptionSection('Mô tả ngắn:',
                          widget.productSuccess.shortDescription),
                    SizedBox(height: 20.0),
                  ],
                ),
              ),
            ...
            bottomNavigationBar: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  // if (widget.productSuccess.pdf_file.isNotEmpty) ...[
                  //   ElevatedButton(
                  ...
                  //     ),
                  //     onPressed: () async {
                  //       await _launchPdf(widget.productSuccess.pdf_file);
                  //     },
                  ...
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      ...
                      padding: EdgeInsets.symmetric(
                          vertical: 15.0, horizontal: 119.0),
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10.0),
                      ),
                    ),
                    onPressed: () {
                      _launchPdf(widget.productSuccess.pdf_file);
                    },
                    child: Text(
                      'Tải để xem sách',
                      style: TextStyle(
  ...
  Future<void> _saveProductDetails() async {
    ...
    prefs.setString('category', widget.productSuccess.category);
    prefs.setString('product_name', widget.productSuccess.productName);
    prefs.setString(
        'detailed_description', widget.productSuccess.detailedDescription);
    prefs.setString(
        'short_description', widget.productSuccess.shortDescription);
    prefs.setDouble('price', widget.productSuccess.price);
    prefs.setDouble(
        'promotional_price', widget.productSuccess.promotionalPrice ?? 0.0);
    prefs.setString('imgProduct', widget.productSuccess.imgProduct);
    prefs.setStringList('album', widget.productSuccess.album ?? []);
    prefs.setString('pdf_file', widget.productSuccess.pdf_file);
    prefs.setInt('quantity', widget.productSuccess.quantity);
  }
