...
class ItemsListCNMMT extends StatefulWidget {
  final ItemTapCallback onItemTap;

  ItemsListCNMMT({required this.onItemTap});

  @override
  _ItemsListState createState() => _ItemsListState();
}

class _ItemsListState extends State<ItemsListCNMMT> {
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          try {
            ...
            if (product.category == "CĐ Nghề Quản Trị Mạng") {
