...
class ItemsListNQTM extends StatefulWidget {
  final ItemTapCallback onItemTap;

  ItemsListNQTM({required this.onItemTap});

  @override
  _ItemsListState createState() => _ItemsListState();
}

class _ItemsListState extends State<ItemsListNQTM> {
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          try {
            ...
            if (product.category == "CĐ Nghề Sửa Chửa Lắp Ráp Máy Tính") {
